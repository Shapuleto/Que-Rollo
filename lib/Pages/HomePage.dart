...
class HomeScreenState extends State<HomeScreen> {
  ...
  controlSearching(String userName){
    Future<QuerySnapshot> allFoundUsers = Firestore.instance.collection("users").where(
      "nickname",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //body: (ElevatedButton.icon(onPressed: logoutUser, icon: Icon(Icons.close), label: Text("Sign Out"))),
